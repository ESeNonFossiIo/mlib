...
// ----------------------------------------------------------------------------
MLIB_EXPORT MLIBStatus MLIB_UTMCentralMeridian(const int64_t zone, ///< [in]  UTM zone [1, 60]
...
// ----------------------------------------------------------------------------
MLIB_EXPORT MLIBStatus MLIB_ComputeZone(const double lon, ///< [in]  longitude in radians
...
// ----------------------------------------------------------------------------
MLIB_EXPORT MLIBStatus MLIB_ArclenOfAMeridian(const double lat, ///< [in]  latitude in radians
...
// ----------------------------------------------------------------------------
MLIB_EXPORT MLIBStatus MLIB_FootpointLat(const double y, ///< [in]  UTM northing in metres
...
// ----------------------------------------------------------------------------
MLIB_EXPORT MLIBStatus MLIB_UTMLatLonToXY(const double lat, ///< [in]  latitude in radians
                                          const double lon, ///< [in]  longitude in radians
