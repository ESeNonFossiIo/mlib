    ...
    {
        {
            ...
            std::cout << "error a -> " << are_equal(a - coef.values[0] / nn, 1e-6) << std::endl;
            std::cout << "error b -> " << are_equal(b - coef.values[1] / nn, 1e-6) << std::endl;
            std::cout << "error c -> " << are_equal(c - coef.values[2] / nn, 1e-6) << std::endl;
