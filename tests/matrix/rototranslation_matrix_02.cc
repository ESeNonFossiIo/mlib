...
int main()
{
  ...
  v.push_back(Point(1.0,1.0,0.0));
  v.push_back(Point(1.0,0.0,1.0));
  v.push_back(Point(1.0,0.0,0.0));
  v.push_back(Point(2.0,3.0,4.0));
  v.push_back(Point(1.0,1.0,5.0));
  v.push_back(Point(2.0,0.0,1.0));
  v.push_back(Point(1.0,3.0,0.0));
  ...
  make_test_pass("matrix/rototranslation_matrix_02");
