...
int main()
{
...

    {
        ...
        std::function<int(std::vector<int>, int)> next_element =
            [](std::vector<int> x, int /* n */) { return x[0] + x[1]; };
...

    {
        ...
        std::function<int(std::vector<int>, int)> next_element =
            [](std::vector<int> x, int /* n */) { return 2 * x[0]; };
...

    {
        ...
        std::function<double(std::vector<double>, int)> next_element =
            [](std::vector<double> /* x */, int n) { return n; };
...

    {
        ...
        std::function<int(std::vector<int>, int)> next_element = [](std::vector<int> x, int n) {
            return x[1] + n;
        };
