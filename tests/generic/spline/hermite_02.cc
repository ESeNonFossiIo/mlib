...
int main()
{
    ...
    std::cout << std::setprecision(9) << std::setw(15) << "t" << std::setw(15) << "tn"
              << std::setw(15) << "x" << std::setw(15) << "y" << std::setw(15) << "tx"
              << std::setw(15) << "ty" << std::setw(15) << "yaw" << std::endl;
    ...
    for (std::size_t i = 0; i <= i_end; i++) {
        ...
        std::cout << std::setw(15) << convert_vector_to_angle(hs.v(t), axes, true).deg()
                  << std::endl;
    }
