...
double Clothoid::l(const double& x) const
{
    return a * x;
}

double Clothoid::k(const double& x) const
{
    return x / a;
}

Point Clothoid::operator()(const double& x) const
{
    Point p;
    p.resize(2);

    const std::function<double(double)>& s = [&](double u) { return this->a * std::sin(u * u); };

    const std::function<double(double)>& c = [&](double u) { return this->a * std::cos(u * u); };
...
ApproximatedClothoid::ApproximatedClothoid(const double& a_) : a(a_)
{
}

double ApproximatedClothoid::l(const double& x) const
{
    return a * x;
}

double ApproximatedClothoid::k(const double& x) const
{
    return x / a;
}

Point ApproximatedClothoid::operator()(const double& x) const
{
    Point p;
    p.resize(2);
