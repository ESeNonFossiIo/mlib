...
double truncate_decimals(double num, double size = 10.0);

std::vector<double> truncate_decimals_vec(std::vector<double>& vec, double size);

template <typename T>
T truncate(T num, T min = std::numeric_limits<T>::min(), T max = std::numeric_limits<T>::max());

template <typename T>
std::vector<T> truncate_vec(std::vector<T>& vec,
 ...
 * @return      derivative
 */
std::vector<double> difference(std::vector<double>& vec, double step = 1, bool left = true);
 ...
 * @return      derivative
 */
std::vector<double> difference(std::vector<double>& y, std::vector<double>& x, bool left = true);

std::vector<double> accumulate(std::vector<double>& vec, double step = 1, bool left = true);

std::vector<double>
force_mean(std::vector<double>& vec, std::size_t consecutive = 4, double toll = 0.1);

std::vector<std::size_t>
flat_part(std::vector<double>& vec, double toll, std::size_t min_num_zeroes = 0);

std::vector<int>
straight_part(std::vector<double>& vec, double toll, std::size_t min_num_zeroes = 0);

std::vector<double>
interpolate(std::vector<double>& vec, std::vector<int>& interpolation, double toll = 0.05);
