...
public:
    ...
    void is_valid_time(const double& t_) const;

    double get_normalized_time(const double& t_) const;
...
public:
    ...
    LinearInterpolation(const Point& p1_, const Point& p2_, const double& t1_, const double& t2_);

    Point operator()(const double& t_) const;
...
public:
    ...
    HermiteSpline5(const Point& p1_,
                   const Point& p2_,
                   const Point& v1_,
                   const Point& v2_,
                   const Point& a1_,
