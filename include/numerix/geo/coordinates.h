 ...
 * @return                      [description]
 */
double arclen_of_a_meridian(const double& lat, const ModelConstants& model = EMC);
 ...
 */
double footpoint_lat(const double& y, const ModelConstants& model = EMC);
 ...
 * @param  model        [description]
 */
void latlon_to_xy(const double& lat,
                  const double& lon,
                  const double& lon0,
                  Point& p,
 ...
 * @param  model        [description]
 */
void xy_to_latlon(const Point& p,
                  const double& lon0,
                  double& lat,
                  double& lon,
                  const ModelConstants& model = EMC);
 ...
 */
Point UTM_latlon_to_xy(const double& lat, const double& lon, const ModelConstants& model = EMC);
