...
#ifndef _NUMERIX_PCL_MATH_
#define _NUMERIX_PCL_MATH_
...
double scalar_product(const PointType& a, const PointType& b)
{
...
pcl::PointXYZI highest_point(pcl::PointCloud<pcl::PointXYZI>::Ptr cloud);

double
min_distance(pcl::PointXYZI& p, pcl::PointCloud<pcl::PointXYZI>::Ptr cloud, double tolerance = 0.0);

void get_closest_points_and_minimum_distance(pcl::PointXYZI& p,
                                             pcl::PointCloud<pcl::PointXYZI>::Ptr cloud,
                                             pcl::PointXYZI& closest_point,
                                             double& min_d);

void neighborhood(pcl::PointCloud<pcl::PointXYZI>::Ptr input,
                  pcl::PointXYZI& p,
                  double& radius,
 ...
 * @return
 */
bool get_farests_points(const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud,
                        float& max_distance,
                        size_t& i1,
                        size_t& i2);
 ...
 */
bool get_closest_points(const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud1,
