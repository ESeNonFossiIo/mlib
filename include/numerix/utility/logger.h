#ifndef _NUMERIX_PCL_LOGGER
#define _NUMERIX_PCL_LOGGER
...
public:
     ...
     */
    Logger(const std::string& filename_ = "", const bool& write_on_stdcout_ = false);
     ...
     */
    void save_on_file(const std::string& filename_ = "");
     ...
     */
    void write(const std::string& msg, const std::string& str, const GeneralColor& color);
