#ifndef _NUMERIX_STRING_UTILITY__
#define _NUMERIX_STRING_UTILITY__
 ...
 * @return a double
 */
double from_str_to_double(const std::string in);
 ...
 * @return a double
 */
std::string from_double_to_str(double Number);
 ...
 * @return a std::size_t
 */
std::size_t from_str_to_unsigned_int(const std::string in);
 ...
 * @return a int
 */
int from_str_to_int(const std::string in);
 ...
 * @return a bool
 */
bool from_str_to_bool(const std::string in);
 ...
 *
 */
std::string hline(const std::size_t& size = 10, const std::string& c = "-");
...
/** @}*/
#endif //_NUMERIX_STRING_UTILITY__
